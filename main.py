...
parser.add_argument('--memory-capacity', type=int, default=40000, metavar='CAPACITY', help='Experience replay memory capacity')
parser.add_argument('--replay-ratio', type=int, default=1, metavar='r', help='Ratio of off-policy to on-policy updates')
