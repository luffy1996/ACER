...
parser.add_argument('--name', type=str, default='results_c10_December13_clipEps', help='Save folder')
...
parser.add_argument('--seppo-clip-param', type=float, default=0.05, help='PPO clip parameters')
